# TITANIC DESASTER DATASET ANALYSIS
This is a Detailed  analysis of the renowned Titanic Disaster Dataset.
The goal of this Ipython notebook is to provide an example of a competitive analysis for those interested in getting into the field of data analytics or using python for Kaggle's Data Science competitions.

1. This is an expert compiled notebook teaching how to tackle real world dataset from start to finish PRACTICALLY.

1. Know how to read in data with pandas
2. Do immense exploratory data analysis with pandas, numpy, matplotlib and seaborn.
3. Create predictive modelling with various sophisticated algorithms like Support Vector Machine, Neural Networks and many more..
